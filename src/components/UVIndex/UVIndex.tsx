...
const UVIndex = () => {
    ...
    return (
        <div className={`${isDarkMode ? 'bg-gray-800 text-white' : 'bg-white text-black'} rounded-xl col-start-1 col-end-3 row-start-6 row-end-7 lg:col-start-1 lg:col-end-2 lg:row-start-5 lg:row-end-6 p-4`}>
